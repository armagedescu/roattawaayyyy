...
%zip7zPath% a -tzip .\ChessAddIn.zip  -xr!.svn -xr!*.bak -xr!btn*.gif -xr!Thumbs.db -xr!IVFFirefoxChess.js -xr!options.js -xr!*snow_queen* -xr!defaults manifest.json .\chrome .\defaults
